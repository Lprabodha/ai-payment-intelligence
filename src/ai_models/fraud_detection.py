            ...
            try:
                ...
                if isinstance(model, PreFittedModelWrapper):
                    try:
                        ...
                        joblib.dump(model.model, f"/src/data/models/fraud_detection_{name}_model.pkl")
                        joblib.dump(model.scaler, f"/src/data/models/fraud_detection_{name}_scaler.pkl")
